...
import au.net.electronichealth.ns.ci.cda.extensions._3.Ingredient;
 ...
 *         &lt;element ref="{http://ns.electronichealth.net.au/Ci/Cda/Extensions/3.0}desc" minOccurs="0"/>
 *         &lt;element name="lotNumberText" type="{urn:hl7-org:v3}ST" minOccurs="0"/>
 *         &lt;element ref="{http://ns.electronichealth.net.au/Ci/Cda/Extensions/3.0}asIngredient" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://ns.electronichealth.net.au/Ci/Cda/Extensions/3.0}formCode" minOccurs="0"/>
 *       &lt;/sequence>
...
public class POCDMT000040Material {
    ...
    @XmlElement(namespace = "http://ns.electronichealth.net.au/Ci/Cda/Extensions/3.0")
    protected List<Ingredient> asIngredient;
    @XmlElement(namespace = "http://ns.electronichealth.net.au/Ci/Cda/Extensions/3.0")
     ...
     * 
     */
    public List<Ingredient> getAsIngredient() {
        if (asIngredient == null) {
            asIngredient = new ArrayList<Ingredient>();
        }
