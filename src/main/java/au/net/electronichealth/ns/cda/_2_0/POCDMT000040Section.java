 ...
 *         &lt;element ref="{http://ns.electronichealth.net.au/Ci/Cda/Extensions/3.0}coverage2" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class POCDMT000040Section {
    ...
    protected List<Coverage2> coverage2;
    ...
    /**
     * Gets the value of the coverage2 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the coverage2 property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCoverage2().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Coverage2> getCoverage2() {
        if (coverage2 == null) {
            coverage2 = new ArrayList<Coverage2>();
        }
