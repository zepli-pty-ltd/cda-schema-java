 ...
 *         &lt;element ref="{http://ns.electronichealth.net.au/Ci/Cda/Extensions/3.0}subjectOf1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class POCDMT000040ManufacturedProduct {
    ...
    protected List<Subject1> subjectOf1;
     ...
     * 
     */
    public List<Subject1> getSubjectOf1() {
        if (subjectOf1 == null) {
            subjectOf1 = new ArrayList<Subject1>();
        }
